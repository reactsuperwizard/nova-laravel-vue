...
Nova.booting(function (Vue, router, store) {
    Vue.component('age-range', __webpack_require__(4));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__RangeFilter__ = __webpack_require__(6);
...
var update = __webpack_require__(10)("0e50b4e8", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        setValue: function setValue(min_value, max_value) {
        ...
        _vm._b(
          {
            ref: "slider",
            model: {
              value: _vm.chenglu.value,
              callback: function($$v) {
                _vm.$set(_vm.chenglu, "value", $$v)
              },
              expression: "chenglu.value"
            }
          },
          "vue-slider",
          _vm.chenglu,
  ...
  return _c(
    ...
    [
      _c(
        ...
        [_vm._v("Chenglu " + _vm._s(_vm.filter.name))]
      ),
      _vm._v(" "),
      _c("RangeFilter", {
        attrs: {
          options: _vm.filter.options,
          minRange: _vm.filter.minRange,
          maxRange: _vm.filter.maxRange,
          intervalVal: _vm.filter.intervalVal
        },
        on: { change: _vm.handleChange },
        model: {
          value: _vm.filter.currentValue,
          callback: function($$v) {
            _vm.$set(_vm.filter, "currentValue", $$v)
          },
