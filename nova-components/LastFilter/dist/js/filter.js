...
Nova.booting(function (Vue, router, store) {
    Vue.component('last-filter', __webpack_require__(2));
});
  ...
  return _c("div", [
    ...
    _c("div", { staticClass: "flex p-2" }, [
      _c("input", {
        ...
        staticClass:
          "block w-full form-control-sm form-input form-input-bordered mr-2",
        attrs: { type: "number", placeholder: "min", name: "min" },
      ...
      _c("input", {
        ...
        staticClass:
          "block w-full form-control-sm form-input form-input-bordered mr-2",
        attrs: { type: "number", placeholder: "max", name: "max" },
